...
<template>
    ...
    <div id="room-modal" class="overlay modal overlay-open:opacity-100 hidden overlay-open:duration-300" role="dialog" tabindex="-1">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h3 class="modal-title">Adicionar Sala</h3>
            <button type="button" class="btn btn-text btn-circle btn-sm absolute end-3 top-3" aria-label="Close" data-overlay="#room-modal">
          ...
          <div class="modal-body">
            <div class="w-96 space-y-4">
              ...
              <div>
                ...
                <input id="roomLocation" v-model="roomForm.location" type="text" placeholder="Bloco A - 1º Andar" class="input" />
              </div>
              <div>
                <label class="label-text" for="roomCapacity">Capacidade*</label>
                <input id="roomCapacity" v-model="roomForm.capacity" type="number" min="1" placeholder="10" class="input" />
              </div>
            </div>
          </div>
                ...
                <tbody>
                    <tr v-for="room in rooms" :key="'room' + room.id">
                        ...
                        <td>
                            ...
                            <button @click1="deleteRoom(room.id)" class="btn btn-circle btn-text btn-sm" aria-label="Excluir sala"><span
